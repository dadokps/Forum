...
namespace LambdaForums.Data.Migrations
{
    ...
    [Migration("20190420120523_Update Post and PostReply")]
    partial class UpdatePostandPostReply
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LambdaForum.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LambdaForums.Data.Models.Post", b =>
                {
                    ...
                    b.HasOne("LambdaForum.Data.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LambdaForum.Data.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
